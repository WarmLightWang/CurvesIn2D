...
/**
 * This program makes the green dot go around the triangle with arc-length parameterization
 */
...
function myTriAL(t) {
  ...
  let st = t * 100; // 300 is the perimeter

  if (st < 130) return lerpPt(triPt1, triPt2, st / 130);
  else if (st < 250) return lerpPt(triPt2, triPt3, (st - 130) / 120);
  else return lerpPt(triPt3, triPt1, (st - 250) / 50);
}
